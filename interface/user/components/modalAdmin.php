...
<div id="modalAdminDetail" class="supp-modal">
    <div class="supp-modal-header">
        <h3 class="coolveticaa supp-modal-title">Admin Detail</h3>
...
<div id="modalAdminAdd" class="supp-modal">
    <div class="supp-modal-header">
        <h3 class="coolveticaa supp-modal-title">Add Admin</h3>
    ...
    <div class="supp-modal-footer">
        ...
        <button class="btn-confirm" onclick="submitAddAdmin()">Save Admin</button>
    </div>
</div>

<div id="modalAdminEdit" class="supp-modal">
    <div class="supp-modal-header">
        <h3 class="coolveticaa supp-modal-title">Edit Admin</h3>
    ...
    <div class="supp-modal-footer">
        ...
        <button class="btn-confirm" onclick="submitEditAdmin()">Update Admin</button>
    </div>
</div>
