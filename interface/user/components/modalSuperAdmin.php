...
<div id="modalAdminDetail" class="supp-modal">
    <div class="supp-modal-header">
        <h3 class="coolveticaa supp-modal-title">Super Admin Detail</h3>
        <button class="supp-close-btn" onclick="closeAdminModal()">&#x2715;</button>
    </div>
...
<div id="modalAdminAdd" class="supp-modal">
    <div class="supp-modal-header">
        <h3 class="coolveticaa supp-modal-title">Add Super Admin</h3>
    ...
    <div class="supp-modal-body">
        <form id="adminAddForm" novalidate enctype="multipart/form-data">
            <div class="supp-form-group">
                ...
                <input type="text" id="addUsername" class="supp-input" placeholder="Enter username" autocomplete="off">
    ...
    <div class="supp-modal-footer">
        ...
        <button class="btn-confirm" onclick="submitAddAdmin()">Save Super Admin</button>
    </div>
</div>

<div id="modalAdminEdit" class="supp-modal">
    <div class="supp-modal-header">
        <h3 class="coolveticaa supp-modal-title">Edit Super Admin</h3>
    ...
    <div class="supp-modal-body">
        <form id="adminEditForm" novalidate enctype="multipart/form-data">
            ...
            <div class="supp-form-group">
                ...
                <input type="text" id="editUsername" class="supp-input" placeholder="Enter username" autocomplete="off">
            ...
            <div class="supp-form-group">
                <label class="supp-label" for="editPassword">Password <span style="font-size: 0.75rem; color: #7A8BA8;">(Leave blank to keep current)</span></label>
    ...
    <div class="supp-modal-footer">
        ...
        <button class="btn-confirm" onclick="submitEditAdmin()">Update Super Admin</button>
    </div>
</div>
