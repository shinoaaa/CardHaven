<?php
// Tangkap tipe laporan dari URL, default ke 'sales'
...
<body>
        ...
        <div class="content-card">
            ...
            <div class="card-title-row" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <h2 class="coolveticaa" style="margin: 0; font-size: 2rem; color: var(--primary-color);">
                    <?= $type === 'sales' ? 'Sales Report' : 'Buyback Report' ?>
                </h2>
            ...
            <?php if ($type === 'sales'): ?>
                <div style="text-align:center; padding: 3rem; color: #888;">
                    <h3>Halaman Sales Report belum dibuat.</h3>
                    <p>Silakan masukkan tabel dan filter untuk Sales di bagian ini.</p>
                </div>
    ...
    <?php if ($type === 'buyback'): ?>
        ...
        <script src="/cardhaven/interface/report-buyback/laporan_buyback_script.js?v=<?= time() ?>"></script>
    <?php endif; ?>
