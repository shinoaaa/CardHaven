...
switch ($action) {
    ...
    case 'export_excel':
        ...
        echo "<tr><td colspan='7' style='font-weight:bold; font-size:14pt; text-align:center;'>Sales Transaction Report</td></tr>";
        echo "<tr><td colspan='7' style='text-align:center; color:#666;'>Generated on: " . date('d-m-Y H:i') . "</td></tr>";
        echo "<tr><td colspan='7'></td></tr>"; // Spasi kosong
        echo "</table>";
        ...
        echo "<th>No</th><th>Date</th><th>Customer</th><th>Product List</th><th>Payment Method</th><th>Total Qty</th><th>Total Sales</th>";
        echo "</tr>";
        ...
        foreach ($data as $row) {
            ...
            // Warna selang-seling seperti di PDF
            ...
            echo "<td style='text-align:center;'>" . $row['nama_metode'] . "</td>";
            echo "<td style='text-align:right;'>" . $row['total_barang'] . "</td>";
        ...
        echo "<td style='text-align:right;'>" . number_format($totalQty, 0, ',', '.') . "</td>";
