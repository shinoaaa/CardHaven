...
// Laporan Buyback: Manager (2) & Owner (3). Role diambil dari session,
...
switch ($action) {
    ...
    header("Content-Disposition: attachment; filename=Laporan_Buyback_{$tanggalSekarang}.xls");
        ...
        echo "<tr><td colspan='6' style='font-weight:bold; font-size:14pt; text-align:center;'>Buyback Transaction Report</td></tr>";
        ...
        echo "<th>No</th><th>Date</th><th>Customer</th><th>Card List</th><th>Total Pcs</th><th>Total Price</th>";
        echo "</tr>";
        ...
        foreach ($data as $row) {
            ...
            echo "<td><b>" . htmlspecialchars($row['nama_customer']) . "</b></td>";
            echo "<td>" . htmlspecialchars($row['daftar_kartu']) . "</td>";
            echo "<td style='text-align:right;'>" . $row['total_barang'] . " Pcs</td>";
        ...
        echo "<td style='text-align:right;'>" . number_format($totalQty, 0, ',', '.') . " Pcs</td>";
    ...
    case 'export_pdf':
        ...
        $pdf->setPrintHeader(true); // Header kustom nonaktif
