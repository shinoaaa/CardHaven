...
$sqlEvent = "SELECT e.nama_event, e.tanggal_sampai, pe.harga_event, p.nama_produk, p.deskripsi, p.harga_jual, p.foto,e.status_event,e.id_event,e.tanggal_mulai,e.tanggal_berakhir
             FROM event e
